...
zxedit.tap: archiver ed edplus3.bin edesx.bin edresi.bin
...
edplus3.bin: zxedit.c
	...
	z88dk-appmake +zx --dos --org 32768 --binfile a.bin --output edplus3.bin
...
edresi.bin: zxedit.c
	...
	z88dk-appmake +zx --dos --org 32768 --binfile a.bin --output edresi.bin
...
edesx.bin: zxedit.c
	...
	z88dk-appmake +zx --dos --org 32768 --binfile a.bin --output edesx.bin
